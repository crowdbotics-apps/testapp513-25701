"""testapp513_25701 URL Configuration
...
admin.site.site_header = "TestApp513"
admin.site.site_title = "TestApp513 Admin Portal"
admin.site.index_title = "TestApp513 Admin"

# swagger
api_info = openapi.Info(
    title="TestApp513 API",
    default_version="v1",
    description="API documentation for TestApp513 App",
)
